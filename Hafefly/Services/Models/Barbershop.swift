...
struct Barbershop: Identifiable, Equatable {
    ...
    static let barbershops = [
        ...
        Barbershop(id: 6, name: "Le Barbier d'Alger", image: "Le Majestic", town: "Bouzareah", rating: 4.8, workingHours: WorkingHours(opening: Date(), closing: Date()), pricing: Pricing(fade: 800, beard: 500, hairdryer: 300, razor: 350, scissors: 500, strightener: 300), coordinate: Coordinate(latitude: 36.7537, longitude: 3.0257), vip: true, barbers: [Barber(id: 6, barbershopID: 6, barbershopName: "Le Barbier d'Alger", profileImage: nil, name: "Ali", bio: "The barber with the magic hands, skilled in all types of haircuts", age: 40, experience: 12, haircutsDone: 2500, instagram: "@ali_barber", isAvailableHome: true, phone: "123-456-7890", province: "Algiers", rating: 5.0, verified: true, workingHours: WorkingHours(opening: Date(), closing: Date()), reviews: [
            Review(id: 1, message: "Great haircut! Highly recommended.", username: "John Doe", rating: 4.5),
            Review(id: 2, message: "Could be better. Average service.", username: "Jane Smith", rating: nil),
            Review(id: 3, message: "Amazing barber! Best haircut I've ever had.", username: "Bob Johnson", rating: 5.0),
            Review(id: 4, message: "Terrible experience. The barber was rude.", username: "Emily Jones", rating: 1.0),
        ...
        Barbershop(id: 7, name: "Babylone Coiffure", image: "Le Majestic", town: "Chéraga", rating: 4.3, workingHours: WorkingHours(opening: Date(), closing: Date()), pricing: Pricing(fade: 300, beard: 100, hairdryer: 50, razor: 50, scissors: 50, strightener: 50), coordinate: Coordinate(latitude: 36.7289, longitude: 2.9307), vip: true, barbers: [Barber(id: 7, barbershopID: 7, barbershopName: "Babylone Coiffure", profileImage: nil, name: "Ali", bio: "The barber with the magic hands, skilled in all types of haircuts", age: 40, experience: 12, haircutsDone: 2500, instagram: "@ali_barber", isAvailableHome: true, phone: "123-456-7890", province: "Algiers", rating: 5.0, verified: true, workingHours: WorkingHours(opening: Date(), closing: Date()), reviews: [
            Review(id: 1, message: "Great haircut! Highly recommended.", username: "John Doe", rating: 4.5),
            Review(id: 2, message: "Could be better. Average service.", username: "Jane Smith", rating: nil),
            Review(id: 3, message: "Amazing barber! Best haircut I've ever had.", username: "Bob Johnson", rating: 5.0),
            Review(id: 4, message: "Terrible experience. The barber was rude.", username: "Emily Jones", rating: 1.0),
