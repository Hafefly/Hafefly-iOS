...
struct Barbershop: Identifiable, Equatable, Codable {
    ...
    static let barbershops = [
        ...
        Barbershop(id: 7, name: "Babylone Coiffure", image: "Le Majestic", town: "Chéraga", rating: 4.3, workingHours: WorkingHours(opening: "2023-03-28T10:00:00Z", closing: "2023-03-28T10:00:00Z"), pricing: Pricing(fade: 300, beard: 100, hairdryer: 50, razor: 50, scissors: 50, straightener: 50, atHome: 100), coordinate: Coordinate(latitude: 36.7289, longitude: 2.9307), vip: true, barbers: [Barber(id: 7, barbershopID: 7, barbershopName: "Babylone Coiffure", profileImage: nil, name: "Ali", bio: "The barber with the magic hands, skilled in all types of haircuts", age: 40, experience: 12, haircutsDone: 2500, instagram: "@ali_barber", isAvailableHome: true, phone: "123-456-7890", province: "Algiers", rating: 5.0, verified: true, workingHours: WorkingHours(opening: "2023-03-28T10:00:00Z", closing: "2023-03-28T10:00:00Z"), reviews: [
            Review(id: 1, message: "Great haircut! Highly recommended.", username: "John Doe", rating: 4.5),
            Review(id: 2, message: "Could be better. Average service.", username: "Jane Smith", rating: nil),
            Review(id: 3, message: "Amazing barber! Best haircut I've ever had.", username: "Bob Johnson", rating: 5.0),
            Review(id: 4, message: "Terrible experience. The barber was rude.", username: "Emily Jones", rating: 1.0),
